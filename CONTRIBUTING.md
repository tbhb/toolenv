...
Thank you for your interest in contributing to toolenv.

## Current status

> [!NOTE]
> toolenv is in early development and is not yet accepting pull requests.
...
- **Report bugs** - If you encounter issues while using toolenv, please open a GitHub issue with a minimal reproducible example
- **Request features** - Have an idea that would make toolenv more useful? Open an issue to start a discussion
- **Improve documentation** - Found a typo or unclear explanation? Documentation improvements are welcome
- **Share feedback** - Open an issue or discussion about how you're using toolenv and what could be better
